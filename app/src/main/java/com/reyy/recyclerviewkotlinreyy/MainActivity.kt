...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val badmintonList = listOf<Badminton>(
            Badminton(
                R.drawable.lining1,
        ...
        val recyclerView = findViewById<RecyclerView>(R.id.rv_shuttlecock)
        recyclerView.layoutManager = LinearLayoutManager(this)
        recyclerView.setHasFixedSize(true)
        recyclerView.adapter = BadmintonAdapter (this,badmintonList){
